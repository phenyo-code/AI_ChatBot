...
export const ConvoIcon = ({ size = 32, className = "" }: { size?: number; className?: string }) => {
  return (
    ...
    >
      <path
        d="M16 2C8.268 2 2 8.268 2 16C2 23.732 8.268 30 16 30C18.614 30 21.058 29.295 23.166 28.166L23.166 22.666C23.166 21.562 22.27 20.666 21.166 20.666H16C14.896 20.666 14 19.77 14 18.666V14C14 12.896 14.896 12 16 12H20.666C21.77 12 22.666 11.104 22.666 10V6.834C20.558 5.705 18.614 5 16 5C9.648 5 4.5 10.148 4.5 16C4.5 21.852 9.648 27 16 27C19.026 27 21.804 25.804 24 24.128V20.666C24 19.562 23.104 18.666 22 18.666H16C14.896 18.666 14 17.77 14 16.666V12C14 10.896 14.896 10 16 10H20.666C21.77 10 22.666 9.104 22.666 8V5.872C20.462 4.196 18.026 3 16 3C8.268 3 2 9.268 2 16C2 23.732 8.268 30 16 30C23.732 30 30 23.732 30 16C30 8.268 23.732 2 16 2Z"
        fill="currentColor"
